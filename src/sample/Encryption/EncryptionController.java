...
public class EncryptionController {
    ...
    private void encryption() {
        ...
        if(yourTextArea != null) {
            String givenText = yourTextArea.getText();
            encryptedText = PlayFair.encrypt(PlayFair.prepareText(givenText));
    ...
    private void saveToFile() {
        if(encryptedTextArea != null) {
            ...
            String path = "D:\\Program Files (x86)\\Projekty\\Enigma\\";
            try {
    ...
    private void loadFromFile() throws IOException {
        String path ="D:\\Program Files (x86)\\Projekty\\Enigma\\src\\text.txt";
